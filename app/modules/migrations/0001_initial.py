    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intro_copy', wagtail.core.fields.RichTextField(blank=True, null=True, verbose_name='Header Intro')),
                ('overview_copy', wagtail.core.fields.RichTextField(blank=True, null=True, verbose_name='Overview Tab Copy')),
                ('student_intro', wagtail.core.fields.RichTextField(blank=True, null=True, verbose_name='Student Page Intro')),
                ('teachers_guide', models.URLField(blank=True, null=True)),
                ('module_download', models.URLField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('module', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='topic_relationship', to='modules.Module')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('module', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='tag_relationship', to='modules.Module')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('module', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='standards_relationship', to='modules.Module')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('module', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='audience_relationship', to='modules.Module')),
            ],
        ),
    ]
